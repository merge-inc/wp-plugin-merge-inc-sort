...
use MergeInc\Sort\Dependencies\DI\Compiler\Compiler;
use MergeInc\Sort\Dependencies\DI\Definition\Source\AnnotationBasedAutowiring;
use MergeInc\Sort\Dependencies\DI\Definition\Source\DefinitionArray;
use MergeInc\Sort\Dependencies\DI\Definition\Source\DefinitionFile;
use MergeInc\Sort\Dependencies\DI\Definition\Source\DefinitionSource;
use MergeInc\Sort\Dependencies\DI\Definition\Source\NoAutowiring;
use MergeInc\Sort\Dependencies\DI\Definition\Source\ReflectionBasedAutowiring;
use MergeInc\Sort\Dependencies\DI\Definition\Source\SourceCache;
...
class ContainerBuilder
{
    ...
    /**
     * If PHP-MergeInc\Sort\Dependencies\DI is wrapped in another container, this references the wrapper.
    ...
    public function build()
    {
        ...
        if ($this->sourceCache) {
            if (!SourceCache::isSupported()) {
                throw new \Exception('APCu is not enabled, PHP-MergeInc\Sort\Dependencies\DI cannot use it as a cache');
            }
     ...
     * set this so that PHP-MergeInc\Sort\Dependencies\DI will use the wrapper rather than itself for building objects.
     *
     * @return $this
     */
     ...
     *   PHP-MergeInc\Sort\Dependencies\DI knows about them and compiles them
