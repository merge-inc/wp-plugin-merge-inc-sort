...
use MergeInc\Sort\Dependencies\DI\Definition\Resolver\DefinitionResolver;
use MergeInc\Sort\Dependencies\DI\Definition\Resolver\ResolverDispatcher;
use MergeInc\Sort\Dependencies\DI\Definition\Source\DefinitionArray;
use MergeInc\Sort\Dependencies\DI\Definition\Source\MutableDefinitionSource;
use MergeInc\Sort\Dependencies\DI\Definition\Source\ReflectionBasedAutowiring;
use MergeInc\Sort\Dependencies\DI\Definition\Source\SourceChain;
use MergeInc\Sort\Dependencies\DI\Definition\ValueDefinition;
use MergeInc\Sort\Dependencies\DI\Invoker\DefinitionParameterResolver;
use MergeInc\Sort\Dependencies\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use MergeInc\Sort\Dependencies\Invoker\Invoker;
use MergeInc\Sort\Dependencies\Invoker\InvokerInterface;
use MergeInc\Sort\Dependencies\Invoker\ParameterResolver\AssociativeArrayResolver;
use MergeInc\Sort\Dependencies\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use MergeInc\Sort\Dependencies\Invoker\ParameterResolver\DefaultValueResolver;
use MergeInc\Sort\Dependencies\Invoker\ParameterResolver\NumericArrayResolver;
use MergeInc\Sort\Dependencies\Invoker\ParameterResolver\ResolverChain;
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain MergeInc\Sort\Dependencies\DI definitions, e.g. MergeInc\Sort\Dependencies\DI\get().
     *
